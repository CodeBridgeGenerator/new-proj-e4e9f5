...
import seederData from "./contact.seeder.json";
...
const ContactSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ContactSeederDialogComponent);
